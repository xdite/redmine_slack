Slack Plugin for Redmine
==========================

This plugin sends messages to your Slack room when issues are created or updated.
...
1. Select 'Configure' next to the Slack plugin and enter the required details.
